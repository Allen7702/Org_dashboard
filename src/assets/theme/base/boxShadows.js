...
/**
 * The base box-shadow styles for the  organization Dashboard React.
 * You can add new box-shadow using this file.
 * You can customized the box-shadow for the entire  organization Dashboard React using thie file.
 */

//  organization Dashboard React Base Styles
import colors from "../../../assets/theme/base/colors";

//  organization Dashboard React Helper Functions
